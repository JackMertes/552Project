...
read_file -format verilog {../rtl/hart.v ../rtl/alu.v ../rtl/rf.v ../rtl/imm.v ../rtl/control_decode.v ../rtl/branch_decode.v ../rtl/ALU_decode.v ../rtl/hazard_unit.v ../rtl/forwarding.v}
